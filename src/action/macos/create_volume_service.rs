...
// };
// use crate::cli::{CURRENT_UID, CURRENT_USERNAME};
//
...
//         check_loaded_command.arg(format!("{}/{}", launchd_domain, this.mount_service_label));
//         tracing::trace!(
...
//             unload_command.arg(format!("{launchd_domain}/{mount_service_label}"));
//             tracing::trace!(
